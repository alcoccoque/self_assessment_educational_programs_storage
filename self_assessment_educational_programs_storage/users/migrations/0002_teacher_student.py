    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Домашня адреса"
                    ),
                ),
                (
                    "teacher_id",
                ...
                (
                    "hire_date",
                    models.DateField(verbose_name="Дата прийняття на роботу"),
                ),
                (
                    "department",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enrollment_date",
                    models.DateField(verbose_name="Дата вступу в заклад освіти"),
                ),
                (
                    "student_type",
                    models.IntegerField(
