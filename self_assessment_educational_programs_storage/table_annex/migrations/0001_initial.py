    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "special_equipment_info",
                    models.TextField(
                        help_text="Якщо освітній компонент потребує спеціального матеріально-технічного та/або інформаційного забезпечення, наведіть відомості щодо нього*",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="table_annex.educationalprogramcomponentsinformation",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "teacher_experience",
                    models.IntegerField(
                        help_text="Стаж науково-педагогічної роботи в роках",
                ...
                (
                    "rationale",
                    models.TextField(
                        help_text="Обґрунтування", verbose_name="Обґрунтування"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "program_educational_components_information",
                    models.ForeignKey(
                        help_text="Наводять відомості, як мінімум, щодо наявності відповідного матеріально-технічного забезпечення, його достатності для реалізації ОП; для обладнання/устаткування – також кількість, рік введення в експлуатацію, рік останнього ремонту; для програмного забезпечення – також кількість ліцензій та версія програмного забезпечення",
                        on_delete=django.db.models.deletion.PROTECT,
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="table_annex.programlearningoutcomecorrespondencematrix",
                        verbose_name="Матриця відповідності програмних результатів навчання, освітніх компонентів, методів навчання та оцінювання",
                    ),
                ),
                (
